...
var kuhong = db.get('ojan'); // jan diubah
	...
	console.log('WELCOME TO MY APIKEY RION') // boleh diubah
}
...
var creator = 'LionSuzune' // ubah jadi nama lu
const listkey = ["touka","Lion","LionSuzune"]; // ubah apikey nya, tambah aja klo mau
